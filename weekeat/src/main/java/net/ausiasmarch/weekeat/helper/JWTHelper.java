...
public class JWTHelper {
    ...
    private static final String SECRET = "weekeat_tfg_2024_1234567890@@$$";
    private static final String ISSUER = "WEEKEAT";
    ...
    public static String generateJWT(String username) {
        ...
        Date expiryTime = Date.from(Instant.now().plus(Duration.ofSeconds(150000)));
